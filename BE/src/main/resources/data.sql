...
insert into user (user_id, password, profile_url) values ('sunny', '1234', 'www.image.com/asdasd');
insert into user (user_id, password, profile_url) values ('cory', '12', 'www.image.com/asdasd');
